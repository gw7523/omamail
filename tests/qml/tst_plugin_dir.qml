...
Item {
  ...
  TestCase {
    ...
    // A host that says where the plugin is, is still obeyed.
    function test_the_manifest_wins_when_it_carries_the_field() {
      compare(hostSaidWhere.pluginDir, "/opt/somewhere-else")
    }
  }
}
